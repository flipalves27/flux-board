...
const sectionShell =
  "rounded-2xl border border-[var(--flux-chrome-alpha-06)] bg-[var(--flux-gradient-panel-sheen)] p-5 shadow-[var(--flux-shadow-inset-panel-top)] transition-[border-color,box-shadow] duration-300 ease-[var(--flux-ease-standard)] hover:border-[var(--flux-primary-alpha-20)] hover:shadow-[var(--flux-shadow-panel-hover)]";
