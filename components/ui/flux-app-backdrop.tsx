 ...
 * `subtle` matches the in-app shell; `immersive` matches the public landing stack (login only by default).
 */
  ...
  if (variant === "immersive") {
    return (
      <div className={`pointer-events-none absolute inset-0 overflow-hidden ${className}`} aria-hidden>
        <div className="flux-aurora-bg absolute inset-0">
        ...
        />
        <div className="flux-grid-overlay flux-grid-overlay--drift absolute inset-0 opacity-[0.36]" />
      </div>
    );
  }
