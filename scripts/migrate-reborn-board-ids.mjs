 ...
 *
 * Ordem de deploy: executar este script (com MONGODB_URI) ANTES de publicar a versão do app sem Reborn.
 *
 * Uso:
 *   MONGODB_URI="..." [MONGODB_DB="..."] node scripts/migrate-reborn-board-ids.mjs
 */
